...
glucose_exchange = ml1515_model.reactions.get_by_id('EX_glc__D_e')
glucose_exchange.lower_bound = -100
glucose_exchange.upper_bound = 100
ex_lcts_e_reaction.lower_bound =-100
ex_lcts_e_reaction.upper_bound = 0
